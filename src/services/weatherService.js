...
const API_KEY = '526113c12e230005842cab1b4969d788'
...
const formatToLocalTime = (sec, offset, format = "cccc, dd, LLL, yyyy' | Local time: 'hh:mm a") => DateTime.fromSeconds(sec + offset, { zone: 'utc' }).toFormat(format);
